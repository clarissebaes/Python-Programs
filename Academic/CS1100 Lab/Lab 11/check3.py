...
class BallDraw(object):
    ...
    def draw_ball(self):
        ...
        bounding_box = (b.ball_x-b.ball_radius, \
                        b.ball_y-b.ball_radius,\
                        b.ball_x+b.ball_radius, \
                        b.ball_y+b.ball_radius) 
        self.canvas.create_oval(bounding_box, fill=b.ball_color)
    ...
    def animate(self):
        ...
        while j<1000:
            ...
            for b in ball_listicle:
                ...
                # Actually refresh the drawing on the canvas.
        
                # Pause execution.  This allows the eye to catch
...
if __name__ == "__main__":
    ...
    while i < 10:
        ...
        b = Ball(x, y, dx, dy, r, c)
        ball_listicle.append(b)
        i+=1
